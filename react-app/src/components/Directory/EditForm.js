...
import { editMaker, loadMakers } from '../../store/maker';
...
function EditForm() {
    ...
    const chosenMaker = allMakers[parseInt(id)];

    const [name, setName] = useState(chosenMaker ? chosenMaker.name : '');
    const [website, setWebsite] = useState(chosenMaker ? chosenMaker.website : '');
    const [instagram, setInstagram] = useState(chosenMaker ? chosenMaker.instagram : '');
    const [country, setCountry] = useState(chosenMaker ? chosenMaker.country : '');
    const [isYarn, setIsYarn] = useState(chosenMaker ? chosenMaker.isYarn : false);
    const [isFiber, setIsFiber] = useState(chosenMaker ? chosenMaker.isFiber : false);
    const [isNotions, setIsNotions] = useState(chosenMaker ? chosenMaker.isNotions : false);
    const [isPattern, setIsPattern] = useState(chosenMaker ? chosenMaker.isPattern : false);
    const [isKnitting, setIsKnitting] = useState(chosenMaker ? chosenMaker.isKnitting : false);
    const [isCrochet, setIsCrochet] = useState(chosenMaker ? chosenMaker.isCrochet : false);
    const [isEmbroidery, setIsEmbroidery] = useState(chosenMaker ? chosenMaker.isEmbroidery : false);
    ...
    const handleSubmit = async (e) => {
        ...
        if (!errors.length) {
            await dispatch(editMaker(editedMaker));
            history.push('/makers');
        };
    };
