...
from .api.maker_routes import maker_routes
from .api.discount_routes import discount_routes
...
app.register_blueprint(maker_routes, url_prefix='/api/makers')
app.register_blueprint(discount_routes, url_prefix='/api/discounts')
